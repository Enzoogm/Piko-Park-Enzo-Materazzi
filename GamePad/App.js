...
import { StyleSheet, Text, View, TextInput, SafeAreaView, TouchableOpacity, Dimensions } from "react-native";
...
export default function App() {
  ...
  const conectarAlServidor = useCallback(() => {
    ...
    socketRef.current = io(`http://${direccionIp}`, { transports: ['websocket'] });
        ...
        <View style={styles.capaVisualFantasmal} pointerEvents="none">
          <View style={styles.zonaDPad}>
            <View style={styles.filaDPad}>
              <View style={styles.botonDireccion}><Feather name="chevron-up" size={42} color="white" /></View>
            </View>
            ...
            <View style={styles.filaDPad}>
              <View style={styles.botonDireccion}><Feather name="chevron-down" size={42} color="white" /></View>
            </View>
          </View>

          <View style={styles.zonaAccion}>
            <View style={styles.botonAccion}><Text style={styles.textoBotonAccion}>A</Text></View>
          </View>
        </View>
      </View>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  barraSuperior: { flexDirection: "row", justifyContent: "space-between", paddingHorizontal: 25, paddingVertical: 15, zIndex: 10 },
  ...
  botonDireccion: { width: 70, height: 70, backgroundColor: "#333", justifyContent: "center", alignItems: "center", margin: 5, borderRadius: 15 },
  centroDPadVacio: { width: 70, height: 70, margin: 5 },
  
  zonaAccion: { alignItems: "center", justifyContent: "center" },
  botonAccion: { width: 95, height: 95, backgroundColor: "#E74C3C", borderRadius: 47.5, justifyContent: "center", alignItems: "center", shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.5, shadowRadius: 5, elevation: 8 },
